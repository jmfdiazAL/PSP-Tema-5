...
class EnviarCorreoSSL {
  ...
  //cuenta de usuario en gmail.com, pon una que exista
  // o si no tienes create una cuenta de correo nueva en gmail
  private static final String cuentaUsuario = "SRIramonm@gmail.com";
  //contraseña (puede ponerse sin miedo, ya que se enviará encriptada)
  private static final String password = "tijola77";
  //dirección de correo del destinatario
  private static final String mailDestinatario = "ramonjmc@yahoo.es";
  ...
  public static void main(String[] args) {
    ...
    try {
      //compone el mensaje de tipo MIME (buscar en wikipedia)
